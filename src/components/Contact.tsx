		...
		<section id="contacto" className="py-32 relative overflow-hidden">
			...
			<div className="max-w-4xl mx-auto px-6 lg:px-8 relative z-10">
				...
				>
					...
					{/* Heading */}
					<h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-light mb-6">
						¿Tienes un proyecto{' '}
						<span className="text-gradient-accent">en mente</span>?
					</h2>
					<p className="text-light-400 text-lg md:text-xl max-w-2xl mx-auto mb-12">
					...
					>
						<button
							onClick={handleCopy}
							className="group relative flex items-center gap-4 px-8 py-6 rounded-2xl bg-dark-100 border border-dark-300/50 transition-all duration-300 hover:border-dark-300 hover:bg-dark-200/50"
						>
							<div className="w-14 h-14 rounded-xl bg-accent/20 flex items-center justify-center">
								<Mail className="w-6 h-6 text-accent" />
							</div>
							<div className="text-left">
								<p className="text-sm text-light-400 mb-1">
									Email
								</p>
							...
							<div className="ml-4 pl-4 border-l border-dark-300">
								{copied ? (
